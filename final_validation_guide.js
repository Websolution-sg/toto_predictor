...
console.log('   typeof predict                            // Should return "function"');
...
console.log('   predict(); // Note result 1');
console.log('   predict(); // Note result 2 - should be identical');
console.log('   predict(); // Note result 3 - should be identical');
...
console.log('   predict(); // Note Range 20 result');
console.log('   document.getElementById("drawRange").value = 50;');
console.log('   predict(); // Note Range 50 result');
console.log('   document.getElementById("drawRange").value = 100;');
console.log('   predict(); // Note Range 100 result');
...
console.log('• Exactly 6 numbers between 1-49 (System 6 only)');
